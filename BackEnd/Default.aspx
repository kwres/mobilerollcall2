<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="BackEnd.Defaults" %>
...
<body>
    ...
    <ext:Window runat="server" Modal="true" Title="Kullanıcı Girişi" Width="400">
        ...
        <Buttons>
             <ext:Button runat="server" Text="Login"   OnDirectClick="btnLoginClick">
                 <DirectEvents>
                     <Click>
