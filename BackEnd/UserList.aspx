...
<body>
        ...
        <TopBar>
            <ext:Toolbar runat="server">
                <Items>
                    ...
                    <ext:Button runat="server" ID="btnCreateNewCourse" Icon="Page" OnDirectClick="btnCreateNewCourse_DirectClick"></ext:Button>
                    ...
                    <ext:TextField runat="server" ID="txtFilter" FieldLabel="Filtre">
                        <RightButtons>
                            ...
                            <DirectEvents>
                                <Click>
                                    <EventMask Msg="Lütfen bekleyiniz" ShowMask="true"></EventMask>                            </Click>
                            </DirectEvents>
                        </ext:Button>
                        </RightButtons>
                    </ext:TextField>
    ...
    <ext:Window runat="server" ID="wndNew" Title="Kullanıcı Kartı" Modal="true" Hidden="true" Width="600" Height="450">
