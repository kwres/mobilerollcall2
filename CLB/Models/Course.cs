...
namespace CLB.Models
{
    public class Course
    {
        ...
        /// <summary>
        /// saves or update course object
        /// </summary>
        /// <returns>Id of object that insert or update</returns>
        public int save()
        {
            ...
            using (MySqlConnection cn = DAL.getCn())
            {
                ...
                //for (int i = 0; i < this.Theorical; i++)
                //{
                //    cn.Insert<CourseTime>(new CourseTime()
                //    {
                //        CourseRef = this.Id,
                ...
                //for (int i = 0; i < this.Practical; i++)
                //{
                //    cn.Insert(new CourseTime()
                //    {
                //        CourseRef = this.Id,
